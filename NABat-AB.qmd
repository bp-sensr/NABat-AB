...
Wind energy farms has been linked to high mortality rates across all bat species in Canada, with long distance migratory species accounting for 73% of recorded fatalities [@zimmerling2016]. In Alberta alone, one estimate predicts an annual mortality rate of 10.9 bats per wind turbine [@zimmerling2016]. There are currently 1778 turbines active across the province (49 different wind farms) with the most turbines found in the grasslands (@fig-turbines). Based on @zimmerling2016 this could mean a total loss of over 19,000 bats per year in the province. As of 2023, COSEWIC designated all three of Alberta's long distance migratory species as endangered due in part to fatalities at wind turbine facilities @canada2024.
